<div id="szkoly_kontener">
    ...
    <form action="<?php echo $this->dolacz ?>organizer.html/nowanotatka" method="post">
        ...
        <input type="submit" value="zapisz" name="zapisznotatka" /> <a href="<?php echo $this->dolacz.'organizer.html' ?>">anuluj</a>
